(function() {
    ...
    let app$utils$eventForm$$radios = document.getElementsByClassName('radioset');
    app$utils$eventForm$$radios = (Array.prototype.slice.call( app$utils$eventForm$$radios, 0 ));
    app$utils$eventForm$$radios.map(t => t.addEventListener('change', function() {
